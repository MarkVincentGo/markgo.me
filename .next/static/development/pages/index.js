...
var Footer = function Footer(_ref) {
  var portfolioButtons = _ref.portfolioButtons;
  ...
  if (portfolioButtons) {
    return __jsx("div", {
      ...
      __self: this
    }, portfolioButtons.map(function (site) {
      return __jsx("a", {
...
var Header = function Header(_ref) {
  ...
  return __jsx("div", {
    ...
    __self: this
  }, portfolioButtons ? portfolioButtons.map(function (info) {
...
var Layout = function Layout(_ref) {
  var children = _ref.children,
      portfolioButtons = _ref.portfolioButtons;
  return __jsx("div", {
    style: layoutStyle,
    __source: {
      fileName: _jsxFileName,
...
var ProjectModal = function ProjectModal(_ref) {
  var selectedProject = _ref.selectedProject,
      closeProjectModal = _ref.closeProjectModal;
...
var Projects = function Projects(_ref) {
  var openProjectModal = _ref.openProjectModal,
  ...
  return __jsx("div", {
    ...
    __self: this
  }, projects ? projects.map(function (card) {
    return __jsx(_ProjectsCard__WEBPACK_IMPORTED_MODULE_1__["default"], {
...
var ProjectsCard = function ProjectsCard(_ref) {
  ...
  if (projectInfo) {
    return __jsx("div", {
      ...
      className: "front",
      style: {
        backgroundImage: "linear-gradient(180deg, rgba(92,91,94,0) 0%, ".concat(projectInfo.color, " 100%)")
      },
      __source: {
        fileName: _jsxFileName,
        lineNumber: 201
      ...
      onClick: function onClick() {
        return openProjectModal(projectInfo);
      },
      style: {
        backgroundImage: "linear-gradient(180deg, ".concat(projectInfo.color, " 0%, rgba(225,225,225,1) 100%)")
      },
      __source: {
        fileName: _jsxFileName,
        lineNumber: 205
      ...
      type: "button",
      style: {
        backgroundColor: "".concat(projectInfo.color),
        color: 'black'
      },
      __source: {
        fileName: _jsxFileName,
...
var Technologies = function Technologies(_ref) {
  ...
  return __jsx("div", {
    ...
    __self: this
  }, stacks ? stacks.map(function (card) {
    return __jsx(_TechnologiesCard__WEBPACK_IMPORTED_MODULE_1__["default"], {
      key: JSON.stringify(card),
      cardInfo: card,
      __source: {
        fileName: _jsxFileName,
...
var TechnologiesCard = function TechnologiesCard(_ref) {
  ...
  if (cardInfo) {
    return __jsx("div", {
      ...
      __self: this
    }, cardInfo.technologies.map(function (technology) {
      return __jsx("div", {
        key: technology,
        __source: {
          fileName: _jsxFileName,
...
/* harmony import */ var _ProjectModal__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./ProjectModal */ "./pages/ProjectModal.jsx");
/* harmony import */ var _Layout__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./Layout */ "./pages/Layout.jsx");
/* harmony import */ var _About__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./About */ "./pages/About.jsx");
/* harmony import */ var _Technologies__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./Technologies */ "./pages/Technologies.jsx");
/* harmony import */ var _Projects__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./Projects */ "./pages/Projects.jsx");
...
var index = /*#__PURE__*/function (_Component) {
  ...
  function index() {
    ...
    _this.openProjectModal = _this.openProjectModal.bind(Object(_babel_runtime_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_4__["default"])(_this));
    _this.closeProjectModal = _this.closeProjectModal.bind(Object(_babel_runtime_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_4__["default"])(_this));
    return _this;
  }

  Object(_babel_runtime_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(index, [{
    key: "openProjectModal",
    value: function openProjectModal(projectInfo) {
      this.setState({
        isModalOpen: true,
    ...
    value: function render() {
      var _this$state = this.state,
          ...
          socialMediaInfo = _this$state.socialMediaInfo,
          technologiesInfo = _this$state.technologiesInfo,
          projectsInfo = _this$state.projectsInfo;
      return __jsx(_Layout__WEBPACK_IMPORTED_MODULE_9__["default"], {
        ...
        __self: this
      }, __jsx(_ProjectModal__WEBPACK_IMPORTED_MODULE_8__["default"], {
        ...
        __self: this
      }), __jsx(_Technologies__WEBPACK_IMPORTED_MODULE_11__["default"], {
